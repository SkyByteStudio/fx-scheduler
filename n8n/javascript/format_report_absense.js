...
const absenceInput =
  $('Prepare Absence Request').item.json;

const previousRunId =
  Number(absenceInput.parent_run_id);

const affectedEmployee =
  absenceInput.employee_number;

const absenceCode =
  absenceInput.absence_code;

const absencePeriod =
  absenceInput.date_from === absenceInput.date_to
    ? absenceInput.date_from
    : `${absenceInput.date_from} to ${absenceInput.date_to}`;
...
const disruptionSection = `
  <section class="card">
    <div class="section-header">
      <div>
        <p class="eyebrow">Schedule disruption</p>
        <h2>Absence and regeneration</h2>
      </div>

      <div class="section-stat">
        Parent run ${escapeHtml(previousRunId)}
      </div>
    </div>

    <div class="context-grid disruption-grid">
      <div class="context-item">
        <span class="label">Affected employee</span>
        <div class="value">
          ${escapeHtml(affectedEmployee)}
        </div>
      </div>

      <div class="context-item">
        <span class="label">Absence code</span>
        <div class="value">
          ${escapeHtml(absenceCode)}
        </div>
      </div>

      <div class="context-item">
        <span class="label">Absence period</span>
        <div class="value">
          ${escapeHtml(absencePeriod)}
        </div>
      </div>

      <div class="context-item">
        <span class="label">Previous run</span>
        <div class="value">
          ${escapeHtml(previousRunId)}
        </div>
      </div>

      <div class="context-item">
        <span class="label">Replacement run</span>
        <div class="value">
